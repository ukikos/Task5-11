...
public class BinaryTreePainter {
    ...
    private static <T extends Comparable<T>> NodeDrawResult paint(SimpleBinaryTreeInterface.TreeNode<T> node, Graphics2D g2d,
                                                                  int x, int y) {
        if (node == null) {
            return null;
        }
     ...
     */
    public static <T extends Comparable<T>> Point paint(SimpleBinaryTreeInterface<T> tree, Graphics gr) {
     ...
     */
    public static <T extends Comparable<T>> void saveIntoFile(SimpleBinaryTreeInterface<T> tree, String filename, boolean backgroundTransparent)
            throws IOException {
     ...
     * @throws Exception Возможное исключение
     */
    public static <T extends Comparable<T>> void saveIntoFile(SimpleBinaryTreeInterface<T> tree, String filename)
            throws IOException {
